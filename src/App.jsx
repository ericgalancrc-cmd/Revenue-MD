                  ...
                  <div className="rise" style={{ background: C.paper2, border: `1px solid ${C.line}`, borderRadius: 18, padding: 24 }}>
                    ...
                    {!A ? (
                      ...
                      <div className="rise">
                        ...
                        <div style={{ background: `linear-gradient(120deg,${C.ink},${C.ink2})`, borderRadius: 14, padding: 16, marginBottom: 18 }}>
                          <div style={{ fontSize: 12, fontWeight: 500, color: C.gold, marginBottom: 6, display: "flex", alignItems: "center", gap: 6, letterSpacing: 1, textTransform: "uppercase" }}>
                            <Brain size={13} /> {t.aiSummary}
                            {c.ai_enhanced && <span style={{ marginLeft: "auto", fontSize: 10.5, fontWeight: 600, color: C.teal, background: "rgba(22,182,201,0.15)", padding: "2px 8px", borderRadius: 8, letterSpacing: 0.5, textTransform: "none" }}>Claude AI ✓</span>}
                          </div>
                          <div style={{ fontSize: 14, lineHeight: 1.65, color: "rgba(255,255,255,.92)" }}>{lang === "en" ? c.sEn : c.sEs}</div>
                          {c.ai_note && <div style={{ marginTop: 10, paddingTop: 10, borderTop: "1px solid rgba(255,255,255,0.1)", fontSize: 12.5, color: C.teal, lineHeight: 1.55 }}>{c.ai_note}</div>}
                        </div>
