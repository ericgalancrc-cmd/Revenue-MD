...
const T = {
  en: {
    ...
    helpN1T: "Denial Risk", helpN1Range: "0 – 99",
    helpN1D: "Tells you how likely this claim is to be denied. Three possible actions — 'Ready to submit': low risk, send it. 'Review before sending': there are warnings worth checking first. 'Do not submit': one or more errors that will almost certainly cause a denial — fix them first.",
    helpN2T: "Payer Rules", helpN2Range: "0 – 100",
    helpN2D: "Checks whether the claim follows the specific rules of the payer — ASES, Medicare, Plan Vital, Triple-S, MMM. 'No action needed': the claim passes all payer rules. 'Verify rules': there is at least one warning worth reviewing against the payer's manual. 'Fix before sending': a rule violation was found that this payer is known to deny.",
    helpN3T: "Documentation", helpN3Range: "0 – 100",
    helpN3D: "Checks how complete the clinical documentation looks. 'No action needed': the chart appears complete. 'Add missing notes': there are gaps — a missing treatment plan, clinical note, or time documentation. 'Complete chart first': significant documentation issues found — the claim is vulnerable in an audit even if the codes are correct.",
  ...
  es: {
    ...
    helpN1T: "Riesgo de denegación", helpN1Range: "0 – 99",
    helpN1D: "Indica qué tan probable es que este reclamo sea denegado. Tres acciones posibles — 'Listo para enviar': bajo riesgo, puedes someterlo. 'Revisar antes de enviar': hay advertencias que conviene revisar primero. 'No enviar': hay uno o más errores que casi con certeza causarán una denegación — corrígelos primero.",
    helpN2T: "Reglas del pagador", helpN2Range: "0 – 100",
    helpN2D: "Verifica si el reclamo cumple con las reglas específicas del pagador — ASES, Medicare, Plan Vital, Triple-S, MMM. 'Sin acción requerida': el reclamo pasa todas las reglas del pagador. 'Verificar reglas': hay al menos una advertencia que vale revisar en el manual del pagador. 'Corregir antes de enviar': se encontró una violación de regla que este pagador suele denegar.",
    helpN3T: "Documentación", helpN3Range: "0 – 100",
    helpN3D: "Verifica qué tan completa parece la documentación clínica. 'Sin acción requerida': el expediente parece completo. 'Agregar notas faltantes': hay vacíos — un plan de tratamiento, nota clínica o documentación de tiempo que falta. 'Completar expediente primero': se encontraron problemas significativos de documentación — el reclamo es vulnerable en una auditoría aunque los códigos sean correctos.",
