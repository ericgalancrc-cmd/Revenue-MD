...
const T = {
  en: {
    ...
    search: "Search claims, codes, payers…", upload: "Upload record", all: "All", highRisk: "Do not submit", pending: "Pending", denied: "Denied", allPayers: "All payers", groupByPayer: "Group by payer",
  ...
  es: {
    ...
    search: "Buscar reclamos, códigos, pagadores…", upload: "Cargar expediente", all: "Todos", highRisk: "No enviar", pending: "Pendiente", denied: "Denegado", allPayers: "Todos los pagadores", groupByPayer: "Agrupar por pagador",
